  ...
  <form action="../partials/_submitquiz.php" method="POST" autocomplete="off">
    <div class="container mt-5">
      ...
      <div class="input-group mb-3 input-group-lg">
        ...
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon1" placeholder="Enter Quiz topic">
      </div>
      <div class="input-group mb-3 input-group-lg">
        <div class="input-group-prepend">
          <span class="input-group-text bg-dark text-white" id="basic-addon3">Time</span>
        </div>
        <input type="number" class="form-control col-md-2" id="basic-url" aria-describedby="basic-addon3" placeholder="Time(in mins)">
      </div>
    </div>
        ...
        <div class="card-body">
          <div class="card-text px-5">
            <div class="form-group row">
              ...
              <input type="text" class="form-control col-md-9" id="question1" name="question1" placeholder="Enter question">
            </div>
            <hr style="border:1px solid darkgrey;" class="mb-4">
            <!-- Options input-->
            <div class="form-group row ">
              <label for="question1option1">Option 1 &nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input type="text" class="form-control col-md-8" id="question1option1" name="question1option1" placeholder="Enter option">
            </div>
            <div class="form-group row">
              <label for="question1option2">Option 2 &nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input type="text" class="form-control col-md-8" id="question1option2" name="question1option2" placeholder="Enter option">
            </div>
            <div class="form-group row">
            ...
            <div class="input-group ">
              ...
              <select class="custom-select" id="inputGroupSelect01" name="question1correctoption">
                ...
                <option value="question1option1" selected>Option1</option>
                <option value="question1option2">Option2</option>
                <option value="question1option3">Option3</option>
                <option value="question1option4">Optiom4</option>
              </select>
            </div>
  ...
  <script type="text/javascript">
    ...
    function addquestion() {      
      ...
      if (qna.length >= 20) {
        ...
        // console.log(allelmnt[8].id);
        // console.log(allelmnt[8].name);
